    ...
    <BackgroundWrapper>
      <div className="min-h-screen flex flex-col items-center justify-center text-center px-6">
        ...
        <h1 className="text-4xl font-extrabold text-blue-400 mb-12 drop-shadow-lg flex items-center gap-3">
          <span role="img" aria-label="cart" className="text-5xl">
            🛒
          </span>
          <span>Dashboard</span>
        </h1>
        ...
        <div className="grid grid-cols-2 gap-6 w-full max-w-md">
          ...
          <button
            ...
            className="bg-red-600 hover:bg-red-700 text-white font-medium py-3 rounded-2xl shadow-lg transition-all hover:scale-105"
          >
            🔒 Logout
          </button>
        </div>
